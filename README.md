...
> Futuristic multimodal transportation operating system frontend prototype built for the UI/UX competition themed: _"Imagine 2100. Design What Comes Next."_
...
- **Travel Style Preferences**: Instant switching between _Fastest_, _Calmest_, _Eco_, and _Low walking_ (selected by default for competition demo flow).
...
- **Quick Locations**: One-tap shortcuts for _Home (Ratmalana District)_ and _Work (Colombo Central)_.
...
- **Route Style**: 2x2 cards (_Fastest_, _Calmest_, _Eco_, _Low walking_).
...
- **Sticky Bottom Action**: Departure status and primary _"Start journey ->"_ button navigating to `/live`.
...
- **Focused Live Action Sheet**:
  ...
  - `NEXT ACTION`: _"Exit at Central Skyport · Doors open on the left"_ with transfer pedestrian icon and _"✓ AeroLink Gate 04 secured (90 sec walk)"_.
  - Direct actions for `Assistance` and `Repeat instruction`.
- **Approaching Transfer State**: Amber-accented gentle reminder at 8 seconds (_"Central Skyport in 2 min"_).
- **Key Wow Moment — AI Network Change & Rerouting**:
  ...
  - Passenger taps _"Accept new route"_: signature path animation morphs the trajectory, maintaining protected arrival at **09:42**.
